...
class RAGPipeline:
    ...
    def retrieve_context(self, query: str, max_docs: int = 3):
        ...
        try:
            ...
            if self.vector_db == "chromadb":
                ...
                class_names = [
                    f"RAG-{self.database_name.replace(' ', '_').lower()}-Temp",
                    f"RAG-{self.database_name.replace(' ', '_').lower()}-{self.database_id}",
    ...
    def query_vector_store(self, query, top_k=5):
        ...
        try:
            ...
            # Use the existing retrieve_context method to get documents
            documents = self.retrieve_context(query, max_docs=top_k)
        ...
        try:
            if self.vector_db == "chromadb":
                ...
                index_paths = [
                    ...
                    f"./faiss_indexes/rag-{self.database_name.lower()}-Temp.index",
                    f"./faiss_indexes/rag-{self.database_name.lower()}-{self.database_id}.index",
                ...
                doc_paths = [
                    ...
                    f"./faiss_indexes/rag-{self.database_name.lower()}-Temp_docs.pkl",
                    f"./faiss_indexes/rag-{self.database_name.lower()}-{self.database_id}_docs.pkl",
