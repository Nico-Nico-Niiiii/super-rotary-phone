...
from app.usecases.agent_development.prompts import DEVELOPER_PROMPT, VALIDATOR_PROMPT, CORRECTOR_PROMPT
...
def get_directory_structure_with_content(directory_path):
    directory_data = {}
    for root, _, files in os.walk(directory_path):
        ...
        for file in files:
            if file.lower().endswith('.png'):
                print(f"Skipping PNG file: {file}")
            ...
            directory_data[relative_path][file] = content
